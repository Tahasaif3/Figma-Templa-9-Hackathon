        ...
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              <Link href={"/Signin"}>
                <button className="w-[80px] h-[80px] flex justify-center items-center mx-auto border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-100 hover:border-2 hover:border-orange-400 sm:w-auto sm:h-[50px]">
                Log in
               </button>
              </Link>
